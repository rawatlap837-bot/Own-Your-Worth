...
const headline = [
  { text: 'Feel Visible.', size: 'text-4xl sm:text-5xl', weight: 'font-medium' },
  { text: 'Feel Valued.', size: 'text-4xl sm:text-5xl', weight: 'font-medium' },
  { text: 'Rebuild Your Confidence.', size: 'text-3xl sm:text-5xl', weight: 'font-medium' },
  { text: 'Reclaim Your Purpose.', size: 'text-3xl sm:text-5xl', weight: 'font-medium' },
  { text: 'Create Your Financial Independence.', size: 'text-4xl sm:text-5xl', weight: 'font-semibold' },
]
      ...
      <div className="relative mx-auto grid max-w-6xl items-start gap-14 px-6 md:grid-cols-2 md:px-10 lg:gap-20">
        ...
        >
          <div className="relative aspect-video w-full max-w-md mx-auto overflow-hidden rounded-2xl border border-white/15 bg-black/40 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.6)] md:max-w-none">
            <iframe
              src="https://player.vimeo.com/video/1223628917?title=0&byline=0&portrait=0&dnt=1"
